...
import InteroperabilityTool from "@/components/interoperability-tool"

export default function InteroperabilityToolPage() {
        ...
        <TierGate requiredTier="SHADOW_ELITE">
          <div className="max-w-4xl mx-auto">
            <div className="mb-8 text-center">
              <GlitchText
                text="SHADOW PROTOCOL INTEROPERABILITY"
                className="text-3xl font-extrabold tracking-tight sm:text-4xl text-neon-pink mb-4"
              />
              <p className="text-neon-cyan font-tech-mono">Seamless Asset Transfers Across Blockchains</p>
              <DataPulse className="my-6" />
            </div>

            {/* Interoperability Tool Component */}
