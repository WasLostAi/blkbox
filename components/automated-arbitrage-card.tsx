  ...
  return (
    <CyberCard className="bg-black/60">
      <div className="flex flex-col items-center">
        <div className="p-3 rounded-full bg-neon-cyan/10 mb-2">
          <Shuffle className="h-6 w-6 text-neon-cyan" />
        </div>
        <h3 className="text-lg font-bold text-neon-cyan mb-1 text-center">Automated Arbitrage</h3>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="bg-neon-cyan/10 text-neon-cyan text-xs font-tech-mono px-2 py-1 rounded">PHANTOM COUNCIL</div>
        </div>
      </div>
    </CyberCard>
  )
